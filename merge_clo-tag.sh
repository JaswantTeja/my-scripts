...
gsa() {
	...
	git commit -S -s -m "Merge tag '${tag}' of https://git.codelinaro.org/clo/la/platform/vendor/qcom-opensource/wlan/qcacld-3.0"
	...
	git commit -S -s -m "Merge tag '${tag}' of https://git.codelinaro.org/clo/la/platform/vendor/qcom-opensource/wlan/fw-api"
	...
	git commit -S -s -m "Merge tag '${tag}' of https://git.codelinaro.org/clo/la/platform/vendor/qcom-opensource/wlan/qca-wifi-host-cmn"
	...
	git commit -S -s -m "Merge tag '${tag}' of https://git.codelinaro.org/clo/la/platform/vendor/opensource/audio-kernel"
